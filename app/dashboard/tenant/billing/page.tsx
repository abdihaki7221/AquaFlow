    ...
    <div className="min-h-screen">
      ...
      <div className="p-6 space-y-6">
        ...
        <motion.div
          ...
          className="glass-card p-6 border-2 border-amber-500/30 bg-gradient-to-r from-amber-500/10 to-amber-600/5"
        >
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
              <div className="text-right">
                ...
                <p className="text-3xl font-bold text-white">KSH {currentBill.amount.toLocaleString()}</p>
        ...
        {showPayModal && selectedBill && (
          ...
          >
            <motion.div
              ...
              className="bg-slate-900/95 backdrop-blur-xl border border-white/20 rounded-2xl shadow-glass p-6 w-full max-w-md"
