      ...
      <header className="glass-navbar sticky top-0 z-40">
        <div className="flex items-center justify-between px-4 lg:px-6 py-3 lg:py-4">
          ...
          <div className="pl-14 lg:pl-0">
            <h1 className="text-lg lg:text-2xl font-display font-bold text-white truncate max-w-[200px] sm:max-w-none">{title}</h1>
            {subtitle && <p className="text-xs lg:text-sm text-white/60 mt-0.5 truncate max-w-[200px] sm:max-w-none">{subtitle}</p>}
          </div>
                ...
                {showNotifications && (
                  <>
                    ...
                    <motion.div
                      ...
                      className="absolute right-0 top-full mt-2 w-[calc(100vw-2rem)] sm:w-80 max-w-sm bg-slate-900/95 backdrop-blur-xl border border-white/20 rounded-2xl shadow-glass overflow-hidden z-50"
                    >
